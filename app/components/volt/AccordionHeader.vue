...
import PrimeAccordionHeader, { type AccordionHeaderPassThroughOptions, type AccordionHeaderProps } from 'primevue/accordionheader';
import { ref } from 'vue';
import { ptViewMerge } from './utils';

// Cast to any to bypass the "Tuple type '[]'" error on the toggleicon slot
const VoltAccordionHeader = PrimeAccordionHeader as any;
